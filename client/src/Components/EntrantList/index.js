...
const EntrantList = props => {
	let style = {
		height: 5 * props.height + "vh",
		overflow: "auto",
	};
	return (
		<div id="entrant-list" style={style}>
			{Object.keys(props.race.entrants).map(entrantName => {
				let entrant = props.race.entrants[entrantName];
				return (
					<div className="entrant-tile">
						<div className="grid-top-left">
							<h3>{entrant.name}</h3>
						</div>
						<div className="grid-bottom-left">
							{entrant.place < 9000 ? entrant.place : ""}
						</div>
						<div className="grid-center">
							<WatchSVG twitch={entrant.twitch !== ""} />
						</div>
						<div className="grid-top-right">
							<svg
								...
								<defs />
								<title />
								<g data-name="219-Dice" id="_219-Dice">
